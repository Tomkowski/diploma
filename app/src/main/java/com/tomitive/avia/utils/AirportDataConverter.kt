...
val airportLocation = mapOf(
    ...
    "EPRA" to "Radom-Sadków, Poland",
    "EPSN" to "Świdwin, Poland",
    "EPTM" to "Tomaszów Mazowiecki, Poland"
)

val airportLocationCoordinates = mapOf(
    "EPCE" to LatLng(54.416250, 17.763306),
    "EPDA" to LatLng(54.404778, 16.353056),
    "EPDE" to LatLng(51.551139, 21.892028),
    "EPIR" to LatLng(52.828694, 18.330083),
    "EPKS" to LatLng(52.331917, 16.966583),
    "EPLK" to LatLng(51.551694, 19.179028),
    "EPLY" to LatLng(52.005000, 19.143917),
    "EPMB" to LatLng(54.026556, 19.135722),
    "EPMI" to LatLng(53.395028, 16.082750),
    "EPMM" to LatLng(52.195556, 21.655889),
    "EPNA" to LatLng(53.454972, 16.489944),
    "EPOK" to LatLng(54.579639, 18.517167),
    "EPPR" to LatLng(54.247722, 18.674500),
    "EPPW" to LatLng(52.379028, 17.852139),
    "EPRA" to LatLng(51.388833, 21.211611),
