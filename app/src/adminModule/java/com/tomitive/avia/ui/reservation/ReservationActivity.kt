...
/**
 * Aktywność wyświetlająca szczegóły rezerwacji dokonywanej przez użytkownika
 */
class ReservationActivity : AppCompatActivity() {
    ...
    /**
     * metoda wykonująca się podczas stworzenia aktywności
     */
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(intent.extras ?: return) {
            ...
            rangeSlider.apply {
                ...
                //1000 milisekund * 60 * 15 = 900000F milisekund -> 15 minut
                stepSize = 900000F
            }
        }
            ...
            reservation_button.setOnClickListener {
                ...
                with(
                    ...
                    val reservationRequest = ReservationRequest(
                        ...
                        classId,
                        if (title.isEmpty()) context.getString(R.string.private_reservation) else title,
    ...
    /**
     * metoda zwracająca godzinę i minutę na podstawie timestampu
     *
     * @param value
     * @return
     */
